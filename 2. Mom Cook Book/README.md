...
Mom's Cook Book is a web application that allows you to search over 1,000,000 (and more) recipes from your childhood.
This repository contains the code for the application developed in JavaScript, which helps users find his favorite dish recipes. How it works? - Just type in the search **pie**, URL is here: https://momcookbook.netlify.app/
...
To use the application, simply run https://momcookbook.netlify.app/ in a web browser and type key work in the Search field.
